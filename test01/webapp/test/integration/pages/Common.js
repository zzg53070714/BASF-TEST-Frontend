sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("dasf/test01/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("dasf.test01.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["dasf/test01/localService/mockserver"], function (mockserver) {
